...
import { AbstractControl, Validators, FormBuilder, FormControl } from '@angular/forms';
...
export class ChangePasswordComponent implements OnInit {
	...
	onSubmit() {
		...
		if (this.changePasswordForm.invalid) {
			...
			let invalid = <FormControl[]>Object.keys(this.changePasswordForm.controls).map(key => this.changePasswordForm.controls[key]).filter(ctl => ctl.invalid);
