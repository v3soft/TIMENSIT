...
exports.chucvuDataSource = void 0;
var rxjs_1 = require("rxjs");
var operators_1 = require("rxjs/operators");
var crud_1 = require("../../../../../../../core/_base/crud");
var chucvuDataSource = /** @class */ (function (_super) {
    __extends(chucvuDataSource, _super);
    function chucvuDataSource(chucvuService) {
        var _this = _super.call(this) || this;
        _this.chucvuService = chucvuService;
        return _this;
    }
    chucvuDataSource.prototype.loadList = function (queryParams) {
        var _this = this;
        ...
        this.chucvuService.findData(queryParams)
            ...
            _this.chucvuService.ReadOnlyControl = res.Visible;
        });
    };
    return chucvuDataSource;
}(crud_1.BaseDataSource));
exports.chucvuDataSource = chucvuDataSource;
//# sourceMappingURL=chucvu.datasource.js.map