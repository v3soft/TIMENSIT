...
const API_PRODUCTS_URL = environment.ApiRoot + '/nav';
...
export class navService {
	...
	// READ
	getAllItems(): Observable<navModel[]> {

		const httpHeaders = this.httpUtils.getHTTPHeaders();
		return this.http.get<navModel[]>(API_PRODUCTS_URL + '?more=true', { headers: httpHeaders });
	}
