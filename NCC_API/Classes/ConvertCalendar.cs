...
namespace Timensit_API.Classes
{
    public class ConvertCalendar
    {
        ...
        /// </summary>
        /// <param name="dd">ngày dương lịch</param>
        /// <param name="mm">tháng dương lịch</param>
        /// <param name="yy">năm dương lịch</param>
        /// <param name="timeZone">timeZone (Viet Nam 7.0)</param>
        /// <returns>array of [ngay am, thang am, nam am, leapOrNot]</returns>
        ...
        /// </summary>
        /// <param name="lunarDay">ngay am lich</param>
        /// <param name="lunarMonth">thang am lich</param>
        /// <param name="lunarYear">nam am lich</param>
        /// <param name="lunarLeap"></param>
        /// <param name="timeZone">Timezone (Viet Nam =7.0)</param>
        /// <returns>array of [ngay duong, thang duong, nam duong]</returns>
        public static int[] convertLunar2Solar(int lunarDay, int lunarMonth, int lunarYear, int lunarLeap, double timeZone =7.0)
        {
            int a11, b11;
            if (lunarMonth < 11)
            {
